...
public class MidlineTurnCommandRed extends Command {
  /** Creates a new TargetNoteCommand. */
  private final SwerveSubsystem swerveDrive;
  private final Timer timer;
  private final ChassisSpeeds midlineTurnChassisSpeeds;

  public MidlineTurnCommandRed(SwerveSubsystem m_swerveDrive) {
  ...
  @Override
  public void execute() {
    if (swerveDrive.getHeading().getDegrees() > -Constants.Auton.TurnTarget){
  ...
  public boolean isFinished() {
    return swerveDrive.getHeading().getDegrees() < -Constants.Auton.TurnTarget; //end command when robot has turned to the target
